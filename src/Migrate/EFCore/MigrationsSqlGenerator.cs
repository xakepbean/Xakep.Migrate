...
namespace Xakep.EntityFrameworkCore.Migrations
{
    public class MigrationsSqlGenerator : IMigrationsSqlGenerator
    {
        ...
        private string ConvertLowerCase(string Val)
        {
            return string.IsNullOrWhiteSpace(Val) ? Val : LowerCase ? Val.ToLower() : Val;
        }
        ...
        public MigrationsSqlGenerator([NotNull] MigrationsSqlGeneratorDependencies dependencies,bool objectNameLowerCase = false)
        {
            Check.NotNull(dependencies, nameof(dependencies));
            LowerCase = objectNameLowerCase;
            ...
            bool terminate)
        {
            ...
            builder
                .Append("ALTER TABLE ")
                .Append(Dependencies.SqlGenerationHelper.DelimitIdentifier(ConvertLowerCase(operation.Table), ConvertLowerCase(operation.Schema)))
                .Append(" ADD ");
            ...
            [NotNull] MigrationCommandListBuilder builder)
        {
            ...
            builder
                ...
                .Append(Dependencies.SqlGenerationHelper.DelimitIdentifier(ConvertLowerCase(operation.Name), ConvertLowerCase(operation.Schema)));
            ...
            bool terminate)
        {
            ...
            builder
                .Append("INDEX ")
                .Append(Dependencies.SqlGenerationHelper.DelimitIdentifier(ConvertLowerCase(operation.Name)))
                .Append(" ON ")
                .Append(Dependencies.SqlGenerationHelper.DelimitIdentifier(ConvertLowerCase(operation.Table), ConvertLowerCase(operation.Schema)))
                .Append(" (")
            ...
            [NotNull] MigrationCommandListBuilder builder)
        {
            ...
            builder
                .Append("DELETE FROM ")
                .AppendLine(Dependencies.SqlGenerationHelper.DelimitIdentifier(ConvertLowerCase(operation.Table), ConvertLowerCase(operation.Schema)));
            ...
            for (var i = 0; i < rowCount; i++)
            {
                ...
                for (var j = 0; j < valueCount; j++)
                {
                    ...
                    builder.Append(Dependencies.SqlGenerationHelper.DelimitIdentifier(ConvertLowerCase(operation.KeyColumns[j])));
            ...
            [NotNull] MigrationCommandListBuilder builder)
        {
            ...
            for (var i = 0; i < rowCount; i++)
            {
                ...
                for (var j = 0; j < valueCount; j++)
                {
                    ...
                    builder.Append(
                        Dependencies.SqlGenerationHelper.DelimitIdentifier(ConvertLowerCase(operation.Columns[j])) +
                        " = " +
            ...
            [NotNull] MigrationCommandListBuilder builder)
        {
            ...
            builder
                .Append(Dependencies.SqlGenerationHelper.DelimitIdentifier(ConvertLowerCase(name)))
                .Append(" ")
            ...
            [NotNull] MigrationCommandListBuilder builder)
        {
            ...
            builder
                ...
                .Append(ColumnList(operation.Columns))
                .Append(") REFERENCES ")
                .Append(Dependencies.SqlGenerationHelper.DelimitIdentifier(ConvertLowerCase(operation.PrincipalTable), ConvertLowerCase(operation.PrincipalSchema)));
        ...
        protected virtual string ColumnList([NotNull] string[] columns)
            => ConvertLowerCase(string.Join(", ", columns.Select(Dependencies.SqlGenerationHelper.DelimitIdentifier)));
